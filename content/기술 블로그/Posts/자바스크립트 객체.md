...
modified: 2017-10-03
원문 링크: https://ddalpange.github.io/blog/2017-10-03-js-study-5
카테고리: Engineering
---
...
5. 자바스크립트의 모든 객체인 또 다른 자바스크립트의 객체인 prototype과 연관되어있다.
6. 객체는 프로토타입으로부터 프로퍼티들을 상속받는다.
7. 객체 리터럴로 생성된 모든 객체는 프로토타입 객체가 같으며, Object.prototype으로 참조할 수 있다.
8. new 키워드를 사용해 생성자를 호출하면 생성자 함수의 프로토타입이 생성된 객체의 프로토타입이 된다.
9. Object.prototype은 아무 프로토타입도 상속받지 않는다.
10. 다른 프로토타입 객체들은 모두 Object.prototype을 상속받는다.
11. 이렇게 프로토타입 객체들이 연결된 것을 프로토타입 체인이라고 한다.
...
원문: [https://ddalpange.github.io/blog/2017-10-03-js-study-5](https://ddalpange.github.io/blog/2017-10-03-js-study-5)