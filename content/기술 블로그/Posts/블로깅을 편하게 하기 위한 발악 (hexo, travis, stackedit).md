...
3. [https://github.com/settings/tokens](https://github.com/settings/tokens) 에서 **repo**만 체크한 후 토큰을 발급받는다. 다른 권한은 필요하지 않다.
4. 헥소 저장소에 **.travis.yml**를 추가하고 **_config.yml**의 deploy 부분을 수정한다.
5. [Github Travis](https://github.com/marketplace/travis-ci)에 들어간 후 hexo blog 레파지토리를 등록해준다..
6. travis에서 해당 레파지토리 settings에 들어간 후 environment variables에 **GITHUB_TOKEN**라는 이름으로 깃허브에서 발급받은 토큰을 등록한다.
...
![[assets/stackedit1.png]]

[Stackedit](https://stackedit.io/)은 온라인 마크다운 에디터다. 오프라인 글쓰기도 지원한다. GitLab, Github, Google Drive 등 왠만한 클라우드 환경은 모두 지원해준다. Github workspace를 등록해주면 자동으로 동기화를 진행한다.
...
![[assets/stackedit-sync.gif]]

---

원문: [https://ddalpange.github.io/blog/2018-11-17-hexo-travis-stackedit](https://ddalpange.github.io/blog/2018-11-17-hexo-travis-stackedit)