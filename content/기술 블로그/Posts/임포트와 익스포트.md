...
base: "[[Untitled.base]]"
작성일: 2017-10-03
원문 링크: https://ddalpange.github.io/blog/2017-10-03-js-import-export
카테고리: Engineering
---
...
-> 나쁘지 않은 방법이다. 하지만 오브젝트를 const로 선언한다면 오브젝트의 프로퍼티 값은 const가 아니기 때문에 [obj.name](http://obj.name/) = "puppy"와 같이 값 자체를 바꿀 수 있다. 엄밀히 따지자면 상수가 아닌 셈이다. (Object.freeze()라는 것을 사용하면 될 수도 ??)
...
원문: [https://ddalpange.github.io/blog/2017-10-03-js-import-export](https://ddalpange.github.io/blog/2017-10-03-js-import-export)