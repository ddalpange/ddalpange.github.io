...
modified: 2017-10-03
원문 링크: https://ddalpange.github.io/blog/2017-10-03-project-make-simple-memo-2
카테고리: Engineering
---
...
모든 페이지를 리턴해주는 *getPages()* 라는 함수를 작성하고, declations, entryComponents 두 속성에 값을 넣어줍니다.
...
**잊지마세요!** 루트모듈만 바꾸면 되는게 아닙니다. 루트 컴포넌트(app.component.ts)에 가서 루트 페이지(시작 페이지)도 같이 바꿔줘야합니다.
...
![[assets/memo-sign-in-page.png]]

![[assets/memo-sign-up-page.png]]
...
원문: [https://ddalpange.github.io/blog/2017-10-03-project-make-simple-memo-2](https://ddalpange.github.io/blog/2017-10-03-project-make-simple-memo-2)